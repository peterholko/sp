...
fn build_balance_report(results: &[RunMetrics]) -> GoblinCrisisBalanceReport {
    ...
    GoblinCrisisBalanceReport {
        ...
        limitations: vec![
            ...
            "The runtime starting Health Potion is overridden to Healing 10 even though the item template declares 50; the baseline reports runtime behavior.".to_string(),
