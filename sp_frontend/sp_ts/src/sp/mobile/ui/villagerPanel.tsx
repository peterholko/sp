    ...
    return (
      ...
      >
        ...
        <table style={tableStyle}>
          <tbody>
            <tr><td>Activity:</td><td>{status.activity}</td></tr>
            <tr><td>Order:</td><td>{status.order}</td></tr>
            <tr><td>Thirst:</td>{this.renderNeedValue("thirst", status.thirst)}</tr>
            <tr><td>Hunger:</td>{this.renderNeedValue("hunger", status.hunger)}</tr>
            <tr><td>Tiredness:</td>{this.renderNeedValue("tiredness", status.tiredness)}</tr>
            <tr><td>Hp:</td><td>{status.hp}</td></tr>
            <tr><td>Stamina:</td><td>{status.stamina}</td></tr>
